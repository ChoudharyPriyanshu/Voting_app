...
async function sendOTPEmail(to, otp) {
    ...
    const mailOptions = {
        from: `"VotoSphere" <${process.env.EMAIL_USER}>`,
        to,
        subject: 'Verify Your VotoSphere Account',
        html: `
            <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #0f0d2e; color: #e2e8f0; border-radius: 16px;">
                ...
                <p style="color: #94a3b8; font-size: 14px; margin-bottom: 24px;">Use the code below to verify your VotoSphere account. This code expires in 10 minutes.</p>
                ...
                <p style="color: #64748b; font-size: 12px;">If you didn't create a VotoSphere account, ignore this email.</p>
            </div>
        `,
    };
